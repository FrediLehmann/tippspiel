			...
			<form onSubmit={form.handleSubmit(onSubmit)}>
				<div className="space-y-3 md:space-y-5">
					<FormField
						...
						render={({ field }) => (
							<FormItem>
								<FormLabel>{t('common.resetPasswordForm.password.label')}</FormLabel>
								<FormControl>
					...
					<FormField
						...
						render={({ field }) => (
							<FormItem>
								<FormLabel>{t('common.resetPasswordForm.passwordConfirmation.label')}</FormLabel>
								<FormControl>
				...
				{error && (
					<Alert variant="destructive" className="mt-4">
						...
						<AlertTitle>{t('common.resetPasswordForm.signupFailAlert.title')}</AlertTitle>
						<AlertDescription>
